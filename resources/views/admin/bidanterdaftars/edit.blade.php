...
<div class="page-heading">
    ...
    <h3>Edit Provinsi: {{ $provinsi->namaprovinsi }}</h3>
</div>
<div class="page-content">
    <div class="card">
        <div class="card-body">
            {{-- Perubahan 2: Form Action --}}
            <form action="{{ route('provinsis.update', $provinsi) }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('namaprovinsi') is-invalid @enderror"
                                id="namaprovinsi" name="namaprovinsi" value="{{ old('namaprovinsi', $provinsi->namaprovinsi) }}" required>
                            @error('namaprovinsi')

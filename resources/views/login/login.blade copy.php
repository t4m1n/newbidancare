    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html"><img src="{{ asset('assets/compiled/png/icon.png') }}" alt="Logo"></a>
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <p>Don't have an account? <a href="{{ route('register') }}" class="btn btn-outline-primary btn-sm">Register</a></p>
                    </div>
                </div>
            </div>
